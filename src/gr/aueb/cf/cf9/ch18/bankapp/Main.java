...
public class Main {
            ...
            try {
                switch (option) {
                    ...
                    case "3" -> {
                        ...
                        System.out.println("Επιτυχής ανάληψης " + withdrawAmount + ", Νέο Υπόλοιπο: " +
                                accountController.getBalance(iban));
                    }
                    case "4" -> {
                        System.out.print("Παρακαλώ εισάγετε το iban :");
                    ...
                    default -> System.out.println("Μη έγκυρη επιλογή. Πορσπαθήστε ξανά.");
                }
    ...
    private static void printMenu() {
        ...
        System.out.println("5. Εκτύπωση όλωων των λογαριασμών.");
